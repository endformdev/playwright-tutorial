...
<Aside>
To start from this step, check out the [`stage-3-endform-integration` branch](https://github.com/endformdev/playwright-tutorial/tree/stage-3-endform-integration) of the [tutorial repository](https://github.com/endformdev/playwright-tutorial).
